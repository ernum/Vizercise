...
type ButtonPropsWeControl = 'aria-haspopup' | 'aria-controls' | 'aria-expanded' | 'onKeyDown' | 'onClick';
...
type ItemsPropsWeControl = 'aria-activedescendant' | 'aria-labelledby' | 'onKeyDown' | 'role' | 'tabIndex';
...
type MenuItemPropsWeControl = 'role' | 'tabIndex' | 'aria-disabled' | 'onPointerLeave' | 'onPointerMove' | 'onMouseLeave' | 'onMouseMove' | 'onFocus';
export type MenuItemProps<TTag extends ElementType> = Props<TTag, ItemRenderPropArg, MenuItemPropsWeControl> & {
    disabled?: boolean;
};
