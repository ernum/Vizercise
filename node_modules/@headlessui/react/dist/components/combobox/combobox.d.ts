...
type InputPropsWeControl = 'role' | 'aria-labelledby' | 'aria-expanded' | 'aria-activedescendant' | 'aria-autocomplete' | 'onKeyDown' | 'onChange' | 'displayValue';
...
type ButtonPropsWeControl = 'tabIndex' | 'aria-haspopup' | 'aria-controls' | 'aria-expanded' | 'aria-labelledby' | 'disabled' | 'onClick' | 'onKeyDown';
...
export type ComboboxLabelProps<TTag extends ElementType> = Props<TTag, LabelRenderPropArg, LabelPropsWeControl>;
...
export type ComboboxOptionProps<TTag extends ElementType, TType> = Props<TTag, OptionRenderPropArg, ComboboxOptionPropsWeControl | 'value'> & {
    disabled?: boolean;
    value: TType;
};
