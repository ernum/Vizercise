...
export type Props<TTag extends ReactTag, TSlot = {}, TOmitableProps extends PropertyKey = never> = CleanProps<TTag, TOmitableProps> & OurProps<TTag, TSlot> & ClassNameOverride<TTag, TSlot>;
type Without<T, U> = {
